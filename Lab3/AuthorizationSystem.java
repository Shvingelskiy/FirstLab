...
public class AuthorizationSystem {
    ...
    public int checkUser(String name, String login, String password, UserInformation []inf) {
        /**
    ...
    public int editInf(String name, String login, String password, UserInformation []inf) {
        /**
         ...
         * @version 1.0
         */
        inf[count-1].setEditInfo(name,login,password);
        return 1;
    }
}
